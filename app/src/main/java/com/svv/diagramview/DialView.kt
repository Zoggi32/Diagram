...
class DialView @JvmOverloads constructor(
    ...
    private val colors = arrayOf(
        Color.parseColor("#7b917b"),
        Color.parseColor("#545449"),
        Color.parseColor("#424632"),
        Color.parseColor("#4c573c"),
        Color.parseColor("#5c6648"),
        Color.parseColor("#5e755d"),
        Color.parseColor("#313d30"),
        Color.parseColor("#191c16"),
        Color.parseColor("#27261a"),
        Color.parseColor("#382c1e"),
        Color.parseColor("#32221a"),
        Color.parseColor("#412227"),
    )
